...
本文档介绍如何定制和配置 LightRAG，包括三语言实体提取器的配置、性能测试和实际使用。
...
# 应该返回: LIGHTRAG_ENTITY_EXTRACTION_USE_TRILINGUAL=true
```
...
- **配置指南**: [docs/TrilingualConfiguration-zh.md](./docs/TrilingualConfiguration-zh.md)
...
- **服务器测试**: [docs/ServerTesting-zh.md](./docs/ServerTesting-zh.md)
- **性能测试**: [docs/SpeedBenchmark-zh.md](./docs/SpeedBenchmark-zh.md)
- **UV 包管理器**: [docs/UVQuickStart-zh.md](./docs/UVQuickStart-zh.md)
- **配置系统**: [docs/ConfigurationGuide-zh.md](./docs/ConfigurationGuide-zh.md)
